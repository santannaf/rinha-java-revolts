...
public final class RedisPrincipalReadClient {
    private static final RedisPrincipalReadClient INSTANCE = new RedisPrincipalReadClient();

    private final JedisPool pool;

    private RedisPrincipalReadClient() {
    ...
    public static RedisPrincipalReadClient getInstance() {
        return INSTANCE;
    }
